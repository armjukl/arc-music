...
export function MobilePlayer({
  ...
  return (
    <>
      ...
      >
        <div
          className={`flex items-center justify-between p-4 border-b border-slate-200/70 ${lyricsExpanded ? "hidden" : ""}`}
        >
        ...
        <div className="flex-1 flex flex-col p-4">
          <div className="flex-1 w-full flex flex-col">
            {hasAnyLyric ? <div className={`w-full ${lyricsExpanded ? "flex-1 flex flex-col" : ""}`}>
